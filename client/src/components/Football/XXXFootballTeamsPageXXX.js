...
const FootballTeamsPage = () => {
  ...
  return (
    <div className="football-teams-page-style">
      <h1 className='TP-title-football'>Fair Suffled Teams</h1>
      <div className="teams-distribution-style-football">
        {teams.map((team, index) => (
          <div key={team.team_id}
          onDragOver={(e) => e.preventDefault()} // Necessary to allow dropping
          onDrop={(e) => handleDrop(e, team)}
          className="team-container-football">
            ...
            <div className="team-players-football">
              <h3>Players:</h3>
      ...
      <div style={{ textAlign: 'center' }}>
        <p>
          <button onClick={handleReRandomize} className="re-shuffle-button-football">
            Re-Shuffle
          </button>
        </p >
        <p>
