...
import './XXXFootballCourtPageXXX.css';
import '../BackHomeButton.css';



const XXXFootballHomePageXXX = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://${process.env.REACT_APP_DB_HOST}:5000/api/football_players/${courtId}`, {
      headers: {
        Authorization: token,
      },
    })
  ...
  return (
    <div className="football-home-page-style">
      ...
      <Link
        to={`/new-player-football/${courtId}?userId=${currUserId}`}
...
export default XXXFootballHomePageXXX;
